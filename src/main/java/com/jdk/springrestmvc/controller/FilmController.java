...
public class FilmController {
    ...
    public ResponseEntity creaFilm(@RequestBody Film film, BindingResult result) {
        java.util.logging.Logger.getLogger(FilmController.class.getName())
                .log(Level.INFO, film.toString());
        if (result.hasErrors()) {
